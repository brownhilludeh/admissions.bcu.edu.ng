...
$(function () {
    ...
    // Required
    $(".form-horizontal, input:required, select:required, textarea:required").prev().append("<span class='required text-danger'> *</span>");


    // Full screen
    $(document).on('click', '#modal-fullscreen', function () {
        $("#main_modal >.modal-dialog").toggleClass("modal-fullscreen");
    });
    ...
    $(document).on("click", ".ajax-modal", function () {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $(".dropify").dropify();
                $("input:required, select:required, textarea:required").prev().append("<span class='required text-danger'> *</span>");
            }
        });
    ...
    //bp File Upload Field
    $(".bp-file").after("<input type='text' class='form-control filename' readOnly>"
        + "<button type='button' class='btn btn-info bp-upload-btn'>Browse</button>");

    $(".bp-file").each(function () {
        if ($(this).data("value")) {
    ...
    $(document).on("click", ".bp-upload-btn", function () {
        $(this).parent().find("input[type=file]").click();
    });

    $(document).on('change', '.bp-file', function () {
        readFileURL(this);
    });
