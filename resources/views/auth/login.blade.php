                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="was-validated">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required value="{{ old('password') }}" placeholder="Enter a strong password" autocomplete="current-password" autocomplete="password">
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
