                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="p-2 was-validated" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required placeholder="Valid email address" autocomplete="phone">
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" required aria-autocomplete="off" autocomplete="off" placeholder="Confirm password">
                        </div>
                        <div>
