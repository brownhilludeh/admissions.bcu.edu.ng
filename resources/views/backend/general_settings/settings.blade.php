...
<div class="row">
    <div class="col-12">
        <ul class="nav nav-tabs setting-tab">
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#general" aria-selected="true">{{ __('General') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#images" aria-selected="true">{{ __('Images/Icons') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#about" aria-selected="true">{{ __('About') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#video" aria-selected="true">{{ __('videos') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#seo" aria-selected="true">{{ __('SEO') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#email" aria-selected="true">{{ __('Email SMTP') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#sms" aria-selected="true">{{ __('SMS') }}</a></li>
            <li class="btn btn-primary btn-sm"><a data-bs-toggle="tab" href="#payment" aria-selected="false">{{ __('Payment API') }}</a></li>
        </ul>
    </div>
    ...
    <div class="col-12">
        <div class="tab-content">
                ...
                <div class="card custom-card mt-2">
                    ...
                    <div class="card-body">
                        <form method="post" class="bp-submit-validate" autocomplete="on" action="{{ route('general_settings') }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="version" value="v2.11.82" required>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('School Name') }}</label>
                                        <input type="text" class="form-control" name="school_name" value="{{ get_option('school_name') }}" required placeholder="BrownPortal Schools">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Site Title') }}</label>
                                        <input type="text" class="form-control" name="site_title" value="{{ get_option('site_title') }}" required placeholder="brownportalng">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('School Abbreviation') }}</label>
                                        <input type="text" class="form-control" name="school_abbv" value="{{ get_option('school_abbv') }}" required placeholder="BPNG">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Site URL') }}</label>
                                        <input type="text" class="form-control" name="site_url" value="{{ get_option('site_url') }}" placeholder="https://brownportal.com" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Whatsapp Link') }}</label>
                                        <input type="url" class="form-control" name="whatsapp" value="{{ get_option('whatsapp') }}" placeholder="https://wa.school.cm/s" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Email') }}</label>
                                        <input type="email" class="form-control" name="email" value="{{ get_option('email') }}" required placeholder="info@brownportal.com">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Currency Symbol') }}</label>
                                        <input type="text" class="form-control" name="currency_symbol" value="{{ get_option('currency_symbol') }}" required placeholder="NGN">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Motto') }}</label>
                                        <input type="text" class="form-control " name="motto" value="{{ get_option('motto') }}" required placeholder="...creating the differenc...">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" name="instagram" value="{{ get_option('instagram') }}" placeholder="http://www.example/your_handle">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Facebook') }}</label>
                                        <input type="url" class="form-control " name="facebook" value="{{ get_option('facebook') }}" placeholder="http://www.example/your_handle">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Youtube') }}</label>
                                        <input type="url" class="form-control " name="youtube" value="{{ get_option('youtube') }}" placeholder="http://www.example/your_handle">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
            ...
            <div id="images" class="tab-pane fad ">
                <div class="row mt-2">
                    <div class="col-md-4">
                        <div class="card custom-card">
                            <div class="card-header">
                                ...
                                <span class="small text-danger"> Image must be less than 250kb</span>
                            </div>
                            <div class="card-body">
                                <form method="post" class="ajax-submit" autocomplete="on" action="{{ route('upload_logo') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <input type="file" class="form-control dropify" name="logo" data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ get_logo() }}" required>
                                    </div>
                                    <div class="card-footer ">
                                        <div class="float-end">
                                            <button type="reset" class="btn btn-danger btn-sm"> {{ __('Reset') }}</button>
                                            <button type="submit" class="btn btn-primary btn-sm"> {{ __('Save Logo') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <form method="post" class="bp-submit" autocomplete="on" action="{{ route('upload_stamp') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <input type="file" class="form-control dropify" name="stamp" data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ get_stamp() }}" required>
                                    </div>
                                    <div class="card-footer">
                                        <div class="float-end">
                                            <button type="reset" class="btn btn-danger btn-sm"> {{ __('Reset') }}</button>
                                            <button type="submit" class="btn btn-primary btn-sm"> {{ __('Save Stamp') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card">
                            <div class="card-header">
                                ...
                                <span class="small text-danger"> Image less than 250kb & 250px X 250px </span>
                            </div>
                            <div class="card-body">
                                <form method="post" class="bp-submit-validate" action="{{ route('upload_favicon') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <input type="file" class="form-control dropify" name="favicon" data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ get_favicon() }}" required>
                                    </div>
                                    <div class="card-footer">
                                        <div class="float-end">
                                            <button type="reset" class="btn btn-danger btn-sm"> {{ __('Reset') }}</button>
                                            <button type="submit" class="btn btn-primary btn-sm"> {{ __('Save Favicon') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <form method="post" class="bp-submit validate " autocomplete="on" action="{{ route('general_settings') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('School Name') }}</label>
                                        <input type="text" class="form-control" name="keywords" value="{{ get_option('keywords') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group  mb-3">
                                        <label class="control-label">{{ __('Site Title') }}</label>
                                        <input type="text" class="form-control" name="site_title" value="{{ get_option('') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description">{{ get_option('description') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('Keywords') }}
                                            <span style="font-size:12px;" class="text-danger"> Write about 10 keywords words </span>
                                        </label>
                                        <textarea class="form-control" name="site_kw" placeholder="school, school name, location, search .... ">{{ get_option('site_kw') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
