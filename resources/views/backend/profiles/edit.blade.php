...
<div class="row ">
    <div class="col-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{ route('profiles.update', $profile['id']) }}" autocomplete="on" class="form-horizontal ajax-submit validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
