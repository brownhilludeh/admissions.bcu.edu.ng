<form action="{{ route('users.update', $data->id) }}" autocomplete="on" class="form-horizontal validate" enctype="multipart/form-data" method="post"
    ...
    <div class="row my-3">
        ...
        <div class="col-sm-9">
            <input type="file" class="form-control dropify" name="image" data-default-file="{{ asset('storage/uploads/' . $data->image) }}"
