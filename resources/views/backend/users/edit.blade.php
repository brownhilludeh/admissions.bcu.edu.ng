    ...
    <div class="col-12">
        <div class="card custom-card">
            <div class="card-header">
                ...
                <small class="text-danger">File format: png, JPEG, jgp, pdf MAx size: 500kb</small>
            </div>
            <div class="card-body">
                <form action="{{ route('users.update', $user['id']) }}" autocomplete="on" class="bp-submit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    <input name="_method" type="hidden" value="PATCH">
                    <div class="row justify-content-end">
                        <div class="form-group col-md-4">
                            <input type="file" class="form-control dropify" data-max-file-size-preview="500K" data-height="100" name="image" data-default-file="{{ asset('uploads/images/' . Auth::user()->image) }}" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <textarea name="about" id="editor" class="form-control">{{ $user->profile->about }}</textarea>
                    </div>
